...
public class dashboardController implements Initializable {
   ...
   // private TextField studentGrade_final;
    @FXML
    private TextField studentGrade_thirdSem;
    @FXML
    private TableColumn<?, ?> studentGrade_col_thirdSem;
    @FXML
            ...
            if (addStudents_studentNum.getText().isEmpty()
                ...
                if (result.next()) {
                    ...
                    String insertStudentGrade = "INSERT INTO student_grade "
                            + "(studentNum,year,course,first_sem,second_sem,third_sem) "
                            + "VALUES(?,?,?,?,?,?)";
    ...
    public void studentGradesUpdate() {
        ...
        try {
            ...
            if (result.next()) {
                ...
                finalCheck3 = result.getDouble("third_sem");
            }
            ...
            String updateData = "UPDATE student_grade SET "
                    ...
                    + "',third_sem = '" + studentGrade_thirdSem.getText() + "' WHERE studentNum = '"
                    + studentGrade_studentNum.getText() + "'";
    ...
    public void studentGradesShowListData() {
        ...
        studentGrade_col_thirdSem.setCellValueFactory(new PropertyValueFactory<>("thirdSem"));
    ...
    public void studentGradesSelect() {
        ...
        studentGrade_thirdSem.setText(String.valueOf(studentD.getThirdSem()));
    }
